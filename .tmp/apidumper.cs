        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                var types = assembly.GetTypes()
                    .Where(t => t.Name.Contains("TopmostEffect") || t.Name.Contains("Marquee") || t.Name.Contains("Rolling") || t.Name.Contains("Weather"))
                    .ToList();
                ...
                foreach (var t in types)
                {
                    ...
                    {
                        sb.AppendLine($"  Method: {m.ReturnType.Name} {m.Name}({string.Join(", ", m.GetParameters().Select(p => p.ParameterType.Name + " " + p.Name))})");
                    }
